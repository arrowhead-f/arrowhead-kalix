 ...
 * string of bytes not conforming to the encoding it is expected to use.
 * <p>
 ...
 */
public class DecoderReadUnexpectedToken extends EncodingException {
    ...
    public DecoderReadUnexpectedToken(
        ...
        this(encoding, reader, token, offset, description, null);
    }
    ...
    public DecoderReadUnexpectedToken(
        ...
        super(encoding, null, cause, true, logger.isDebugEnabled());
    ...
    public String getMessage() {
        return "Decoding " + encoding() + " failed at source offset " +

...
public interface HttpClientConnection {
    ...
    /**
     * @return {@code true} only if this client can be used to send requests to
     * its remote peer.
     */
    boolean isLive();
    ...
    /**
     * Sends given {@code request} to HTTP service represented by this
     * {@code HttpClient}, awaits either a response or an error, closes this
     * connection and then completes the returned {@code Future} with either

...
public class NettyHttpServiceRequest implements HttpServiceRequest {
    ...
    private final NettyHttpRequester requester;
    ...
    public static class Builder {
        ...
        private NettyHttpRequester requester;
        private QueryStringDecoder queryStringDecoder;

        public Builder body(final NettyHttpServiceRequestBody body) {
            this.body = body;
            return this;
        }
        ...
        public Builder requester(final NettyHttpRequester requester) {

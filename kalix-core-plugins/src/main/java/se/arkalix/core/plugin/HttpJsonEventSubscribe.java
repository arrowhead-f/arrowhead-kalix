...
import se.arkalix.core.plugin.dto.EventSubscriptionDto;
...
public class HttpJsonEventSubscribe implements ArConsumer, ArEventSubscribe {
    ...
    HttpJsonEventSubscribe(final HttpConsumer consumer) {
    ...
    @Override
    public Future<?> subscribe(final EventSubscriptionDto subscription) {
